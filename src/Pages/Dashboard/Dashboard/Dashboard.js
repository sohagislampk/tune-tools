...
const Dashboard = ({ dbUser }) => {
    ...
    return (
        <div>
            <h1 className='text-2xl md:text-5xl font-bold text-center my-6'>Welcom {user.displayName}</h1>
            <div className='flex flex-col items-center border-4 border-secondary mx-6 md:mx-20 py-10'>
